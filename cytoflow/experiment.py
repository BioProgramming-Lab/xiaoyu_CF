...
def _is_categorical_dtype(dtype):
    """Compatibility wrapper for pandas categorical dtype checks."""
...
class Experiment(HasStrictTraits):
    ...
    def add_events(self, data, conditions):
        ...
        for meta_name, meta_value in conditions.items():
            ...
            if _is_categorical_dtype(meta_type):
            ...
            if _is_categorical_dtype(meta_type) and meta_name in self.data:
